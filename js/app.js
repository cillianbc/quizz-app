$(document).ready(function() {
  questions =[
  {
    ...
    choices : [23,21,19,25],
    fact:"In US College volleyball the game is played to 30 points",
    correct:3
  },
  {
    ...
    fact:"Volleyball is one of the most ppopular sports in the world",
    correct:1
  },
  {
    ...
    fact:"The setter is the most specialised position on the court",
    correct:2
  },
  {
    ...
    fact:"The indoor court is 9m x 9m, outdoor beach courts are 8m x 8m",
    correct:0
  }
]
...
function nextQuestion(){
  if (currentQuestion < 4){
    ...
    $("#last_fact").html(lastFact).fadeIn();
      }
  else {
    $(".question").remove();
    $("#answer_holder input").remove();
